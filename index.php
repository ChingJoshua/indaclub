...
<body>
    ...
    <!--Buttons below-->
    <div style="display: flex; justify-content: center; margin: 0px; padding: 0px; margin-top: 30px;"><a href="login.php" style="text-decoration: none; color: black"><button type="button" class="btn btn-primary btn-lg login">Login</button></a></div>
